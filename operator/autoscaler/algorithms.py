...
__author__ = "Claudio Cicconetti & Naufal Weise"
__version__ = "1.0.0"
__license__ = "MIT"
...
class Partitioner:
    ...
    def __init__(
        ...
        lr: float = 1e-3,
        u: float = 5e-3,
        r: int = 1, # replication factor
        c: int = 100, # initial number of customer
    ):
    ...
    def bromin_scale(
        ...
        Args:
            c (int): Current Number of consumers.
            b (int): Current Number of brokers.
            t (int): Current throughput
            always_scale (bool): If true, the returned brokers will always be bigger than current number. 
            Used to accommodate scaling with metrics that is not included in original bromin algo, like cpu load.
        Returns:
        ...
        for b in range(min_brokers, b + MAX_BROKERS_INCREASE, 1):
