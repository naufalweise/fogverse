...
JOLOKIA_URL = f"https://search.maven.org/remotecontent?filepath=org/jolokia/jolokia-agent-jvm/{JOLOKIA_VERSION}/jolokia-agent-jvm-{JOLOKIA_VERSION}-javaagent.jar"
